...
{
    static internal class WininetProxy
    {
        ...
        #region Wininet Function Declarations
        ...
        static public bool SetProxyInfo(String sConnection, String sProxyServer, String sProxyExceptions, String sAutoConfigURL)
        {
            ...
            else
            {
                ...
                if (!InternetSetOption(IntPtr.Zero, InternetOptionActions.INTERNET_OPTION_PER_CONNECTION_OPTION, ref request, request_len))
                {
                    // int e = Marshal.GetLastWin32Error();  // Not used, but lets us peek at error value when we're debugging.
                ...
                else
                {
                    ...
                    InternetSetOption(IntPtr.Zero, InternetOptionActions.INTERNET_OPTION_SETTINGS_CHANGED, IntPtr.Zero, 0);
                    InternetSetOption(IntPtr.Zero, InternetOptionActions.INTERNET_OPTION_REFRESH, IntPtr.Zero, 0);
